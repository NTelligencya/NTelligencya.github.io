...
export const CHECKPOINTS = [
  ...
  { id: 'login', title: 'Log in to the router', brief: 'Open the router\u2019s management page in the browser and sign in with the factory credentials from the label.',
    hints: ['The address is on the label, and it is also the Default Gateway in ipconfig.', 'Type it in the address bar, not the search box.', 'Browse to the router\u2019s address and sign in with the default user name and password printed on the label.'],
  ...
  { id: 'printer', title: 'Add the network printer', brief: 'Join the printer to your 2.4 GHz network, add it on the PC, and print a test page.',
    hints: ['The printer joins the network from its own panel on the bench first.', 'If Windows does not list it, add it by its IP address.', 'Printer panel: join your 2.4 GHz SSID with the passphrase. PC: Printers & scanners > Add device, or Add manually by IP. Then Print test page.'],
