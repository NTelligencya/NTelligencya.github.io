...
<section class="sec" id="context">
  ...
  <div class="tblwrap"><table class="tbl">
    ...
    <tbody>
      ...
      <tr class="tbl__total"><td>Seven units</td><td>about 12.5 hours in total</td><td>Set-up and the model unit took more than a third of it; the other six units averaged under an hour and a half each.</td></tr>
    </tbody>
  </table></div>
